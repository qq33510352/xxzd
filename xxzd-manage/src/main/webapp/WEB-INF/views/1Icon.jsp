...
<body>
	<!-- 想使用 layui的 图标 只需要在容器(div span等)里添加class 为  lay-icon 
	并且在内容里输入 指定字符或 加上图标class也行 -->
	
	
	<span class="layui-icon" style="font-size: 50px">&#xe676;</span> <!--可以通过字体大小设置样式-->
	<div class="layui-icon layui-icon-404" style="font-size: 50px;">
	</div>
